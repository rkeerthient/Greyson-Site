 ...
 */
export function getDisplayableAppliedFacets(
...
export function getDisplayableStaticFilters(
  staticFilters: any[] | undefined,
  groupLabels: Record<string, string>
): DisplayableFilter[] {
  let appliedStaticFilters: DisplayableFilter[] = [];
  staticFilters &&
    staticFilters.forEach((selectableFilter) => {
 ...
 */
export function getDisplayableNlpFilters(
  filters: AppliedQueryFilter[]
): DisplayableFilter[] {
